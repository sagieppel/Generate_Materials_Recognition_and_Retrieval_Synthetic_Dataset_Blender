...
import numpy as np
import shutil
indir = "/media/deadcrow/6TB/python_project/Can_LVM_See3D/10_EVERYTHING_DIFFERENT/" # input filter dir
####max_seg=1 # maximum number of none connected segment in object mask
min_occupancy=0.025 # minimum fraction of image occupied by mask
trash_dir= "/media/deadcrow/6TB/python_project/Can_LVM_See3D/10_EVERYTHING_DIFFERENT_trash/" # where filtered files will be saved
##############Recursive scan####################################################################3
